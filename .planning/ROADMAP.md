...
| 5. 新增一个 API 功能：通过登录用户的 token 调用 API 自动导入账户，支持现有导入方式复用，但入口改为 API + 用户 token 认证 | 2/2 | Complete | 2026-05-04 |
...
- [x] Plan 05-02: Regenerate Worker, Docker, and Netlify backend bundles and assert generated Bearer import behavior
