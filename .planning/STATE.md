...
|---|-------------|------|--------|-----------|
| 260504-i3a | fix Cloudflare D1 schema sync for active_share_key deployment | 2026-05-04 | pending | [260504-i3a-fix-cloudflare-d1-schema-sync-for-active](./quick/260504-i3a-fix-cloudflare-d1-schema-sync-for-active/) |
