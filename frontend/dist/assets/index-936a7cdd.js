    ...
    const nc = [
        {
            path: "/",
            name: "Home",
            component: it(()=>oe(()=>import("./home-4662a7b2.js").then(async (m)=>{
                        await m.__tla;
                        return m;
