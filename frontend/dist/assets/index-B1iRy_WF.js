    ...
    const nc = [
        {
            path: "/",
            name: "Home",
            component: it(()=>oe(()=>import("./home-DtuBT6CP.js").then(async (m)=>{
                        await m.__tla;
                        return m;
